...
\begin{enumerate}
  ...
  \item \vpred{individuals} receives the correct frame label, People, but is missing an argument 
  (``wealthy'' should fill the Descriptor frame element). In other wordings of this sentence, 
  ``wealthy'' was correctly identified as an argument to People, but incorrectly labeled 
  with the Ethnicity frame element. 
